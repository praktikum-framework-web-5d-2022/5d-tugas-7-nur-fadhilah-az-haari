        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-secondary p-4">
                    <h2 class="text-center">Tambah Data Pelayan</h2>
                    ...
                    <form action="{{route('pelayan.store')}}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="menu_seblak" id="menu_seblak" class="form-select">
                                ...
                                <option value="Seblak Biasa" {{old('menu_seblak') == "Seblak Biasa" ? "selected" : ""}}>Seblak Biasa</option>
                                <option value="Seblak Tulang" {{old('menu_seblak') == "Seblak Tulang" ? "selected" : ""}}>Seblak Tulang</option>
                                <option value="Seblak Mie" {{old('menu_seblak') == "Seblak Mie" ? "selected" : ""}}>Seblak Mie</option>
                                <option value="Seblak Seafood" {{old('menu_seblak') == "Seblak Seafood" ? "selected" : ""}}>Seblak Seafood</option>
                                <option value="Seblak Komplit" {{old('menu_seblak') == "Seblak Komplit" ? "selected" : ""}}>Seblak Komplit</option>
                            </select>
                            @error('menu_seblak')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
